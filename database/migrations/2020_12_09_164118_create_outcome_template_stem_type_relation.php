...
class CreateOutcomeTemplateStemTypeRelation extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('outcome_template_stem_type_relation', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('outcome_template_stem_type_relation');
    }
}
