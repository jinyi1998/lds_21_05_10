...
const TourGuide = (props) => {  
    ...
    const steps_design_type = [
       {
         ...
         content: (
             <React.Fragment>
                 ...
                 Choose Engineering design if you want students to construct some products to address an authentic problem
                 , or Scientific investigation in which students design and conduct a scientific investigation to address a scientific problem. 
                 </Typography>
             </React.Fragment>
         ),
         disableBeacon: true,
    ...
    const steps_course_info = [
        ...
        content: (
            <React.Fragment>
                <Typography variant="caption">
                Please input some basic information of the unit, 
                including the unit title, 
                grade level targeted, no. of lessons and curriculum unit description.
                </Typography>
            </React.Fragment>
        ),
        disableBeacon: true,
    ...
    const steps_ulo = [
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                    Learning design starts with the identification of learning outcomes. 
                    LDS pre-loaded some learning outcomes based on your selection of “Engineering Design”. 
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                    You may edit or remove these pre-loaded learning outcomes when not needed.
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                    Teachers can also add more learning outcomes.
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                    You need to choose the type of learning outcomes. 
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                    It is also very important to make learning outcomes realistic and can be assessed. 
                    Teachers need to consider the level of achievement to be reached. 
                    LDS uses the Bloom’s Taxonomy to help teachers specify the level of outcome targeted. 
                    </Typography>
                </React.Fragment>
            ),
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                    STEM education requires integration of four disciplinary domains. Which STEM domain does this learning outcome belong to? 
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                        Some keywords are suggested for you to write a well-specified learning outcome here. The keywords are suggested based on your selection of Bloom’s taxonomy.
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
    ...
    const steps_component_step = [
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                    Teachers can re-order or add a curriculum component if necessary.
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
    ...
    const steps_unit_design_component = [
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                        In this step, You will design the specifiable learning outcomes achieved and sequence of learning activities for each component. 
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
        ...
        },
        {
            ...
            content: (
                <React.Fragment>
                    <Typography variant="caption">
                        LDS has pre-loaded two some learning outcomes which are possible to be achieved in this component. 
                    </Typography>
                </React.Fragment>
            ),
            disableBeacon: true,
